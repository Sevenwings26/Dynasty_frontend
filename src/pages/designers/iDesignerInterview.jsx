    ...
    <div className="bg-noir-900 min-h-screen py-16 px-6 md:px-20 w-full flex-1">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl sm:text-5xl font-serif text-white font-bold text-center mb-12 leading-tight">
          An Interview Session with <span className="text-gold-400">Sannah Fashion Hub</span>
        </h1>
        ...
        {/* Interview Content */}
        <div className="space-y-8 space-y-8 text-zinc-300 text-base sm:text-lg leading-relaxed font-light">
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">1. Could you share the vision and story behind the founding of your fashion brand?</h2>
            <p className="mb-2">
          ...
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">2. What sets your brand apart from others in the fashion industry?</h2>
            ...
            <div className="rounded-2xl overflow-hidden border border-zinc-800 shadow-xl my-8 bg-zinc-950 p-2">
              <img src={images[2]} alt="Model in motion" className="w-full object-contain rounded-xl max-h-[550px]" />
            </div>
          </div>
          
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">3. What significant challenges have you faced in growing and sustaining your brand, and how have you overcome them?</h2>
          ...
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">4. Can you discuss the creative process behind the design of your collections?</h2>
            ...
            <div className="rounded-2xl overflow-hidden border border-zinc-800 shadow-xl my-8 bg-zinc-950 p-2">
              <img src={images[4]} alt="Model in motion" className="w-full object-contain rounded-xl max-h-[550px]" />
            </div>
          </div>
          <br/>
          <br/>
          <div className="mb-2">
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">6.	Can you discuss any collaborations or partnerships your brand has engaged in and their impact?</h2>
          ...
          <div className="mb-2">
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">7. What is your brand’s approach to incorporating trends while maintaining a timeless appeal?</h2>
          ...
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">8. How does your brand stay relevant in an ever-changing industry and market?</h2>
          ...
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">9. What are the key values and principles that guide your brand’s business decisions?</h2>
          ...
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">10. How do you navigate the balance between maintaining brand identity and adapting to evolving consumer preferences?</h2>
          ...
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">11. Can you share the strategies your brand employs to connect with and engage its target audience?</h2>
            ...
            <div className="rounded-2xl overflow-hidden border border-zinc-800 shadow-xl my-8 bg-zinc-950 p-2">
              <img src={images[0]} alt="Model in motion" className="w-full object-contain rounded-xl max-h-[550px]" />
            </div>

          </div>
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">12. How does your brand approach pricing to ensure both accessibility and quality?</h2>
            <p className="mb-2">
          ...
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">13. How do you see your brand evolving in the next 5-10 years?</h2>
            <p className="mb-2">
          ...
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">14. Can you discuss any unique or signature elements that consistently appear in your designs?</h2>
            <p className="mb-2">
          ...
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">15. Could you talk about any technological innovations your brand has embraced in its operations and product development?</h2>
            <p className="mb-2">
          ...
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">16. What are some defining moments in your brand’s history that have shaped its identity and trajectory?</h2>
            <p className="mb-2">
            ...
            <div className="rounded-2xl overflow-hidden border border-zinc-800 shadow-xl my-8 bg-zinc-950 p-2">
              <img src={images[3]} alt="Model in motion" className="w-full object-contain rounded-xl max-h-[550px]" />
            </div>

          </div>
          <div>
            <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">17. Can you share any upcoming projects or endeavors your brand is particularly excited about?</h2>
...
// Review: “Culture Fit” Collection by Sannah FashionHub
