      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-8 leading-relaxed text-gray-800">
          ...
          <div>
            ...
            <p>What makes Sannah Fashion Hub stand out is our blend of creativity, cultural inspiration, and attention to detail. We don’t just design clothes we design experiences that make people feel seen and confident. <br />
          ...
          <div>
            ...
            <p>At Sannah Fashion Hub, every collection begins with a story. We draw inspiration from culture, emotion, and everyday beauty blending creativity with purpose. Our design process is both intuitive and intentional, from the first sketch to the final stitch. <br />
            ...
            <div>
            <h2 className="font-semibold text-xl mb-2">5.	How does your brand cater to diverse body types and sizes?</h2>
            <p>At Sannah Fashion Hub, we believe style has no size limit. From the beginning, our goal has been to design clothes that make every person feel confident and seen. Fashion should celebrate individuality not fit everyone into the same mould. <br/>
          ...
          <div>
            ...
            <p> Fashion moves fast, but at Sannah Fashion Hub, we stay relevant by staying true to who we are while always being open to growth and innovation. We keep a close eye on changing trends, customer preferences, and cultural shifts, but we never lose sight of our core values: creativity, quality, and authenticity. <br/>
          ...
          <div>
            ...
            <p>At Sannah Fashion Hub, our business decisions are rooted in a few simple but powerful values authenticity, creativity, quality, and inclusivity. These principles shape everything we do, from design to production to how we engage with our customers. <br/>
          ...
          <div>
            ...
            <p>At Sannah Fashion Hub, we see fashion as a conversation between creativity and the people we design for. Staying true to our brand identity while adapting to evolving consumer tastes is about balance knowing when to evolve and when to stay grounded in what makes us unique. <br/>
          ...
          <div>
            ...
            <p>At Sannah Fashion Hub, we believe that meaningful connection goes beyond selling clothes it’s about building a community that shares our passion for style, culture, and self-expression. <br/>
