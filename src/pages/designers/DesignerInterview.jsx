      ...
      <div className="bg-noir-900 min-h-screen py-16 px-6 md:px-20 w-full flex-1">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-8 text-zinc-300 text-base sm:text-lg leading-relaxed font-light">
            <div>
              <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">“Culture Fit” Collection by Sannah FashionHub</h2>
              <p className="mb-2">
            ...
            <div>
              <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">Design Concept and Inspiration</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">Color Palette and Textiles</h2>
              <p className="mb-2">
            ...
            <div>
              <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">Silhouettes and Styling</h2>
              <p className="mb-2">
            ...
            <div>
              <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">Overall Presentation</h2>
              <p className="mb-2">
            ...
            <div>
              <h2 className="font-serif text-xl sm:text-2xl text-white font-bold mb-3">Final Verdict</h2>
              <p className="mb-4">
