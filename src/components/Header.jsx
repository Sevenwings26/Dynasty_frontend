...
function Header() {
  ...
  return (
    <Navbar
      collapseOnSelect
      expand="lg"
      className="bg-white drop-shadow uppercase"
    >
      <Container>
        <Navbar.Brand href="/">
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Nav>
            ...
            {isLoggedIn ? (
              <>
                <span className="nav-link m-2 font-bold animate-pulse border border-gray-700 text-red-400 rounded-lg p-2">
                  {username} {/* Display the username */}
                </span>
                <span
                  className="nav-link m-2 text-black"
